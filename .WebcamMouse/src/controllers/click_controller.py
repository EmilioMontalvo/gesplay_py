        ...
        while not self.is_stoped:
            ...
            if self.curr_image_results is not None and debug_image is not None:
                if self.curr_image_results.multi_hand_landmarks is not None:
                    for hand_landmarks, handedness in zip(self.curr_image_results.multi_hand_landmarks,
                                                          self.curr_image_results.multi_handedness):
                        landmark_list = LandmarkProcessor().calc_landmark_list(image=debug_image,
